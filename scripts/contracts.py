...
def load_accounts():
    ...
    if network.show_active() in ['goerli', 'ropsten', 'kovan', 'rinkeby']:
       ...
       # Note: Only to deploy. Dont send eth to this address
        accounts.add(
            '55a24ceff28920d9fe1d9c2ac20be0424b8b1aec43912345bc6991e43eb12345')
        accounts.add(
        ...
        accounts.add(
            '55a24ceff28920d9fe1d9c2ac20be0424b8b1aec43912345bc6991e43eb45345')
        accounts.add(
            '55a24ceff28920d9fe1d9c2ac20be0424b8b1aec21912345bc6991e43eb12345')
        accounts.add(
            '55a24ceff28920d9fe1d9c2ac20be0422b8b1aec43912345bc6991e43eb12345')
